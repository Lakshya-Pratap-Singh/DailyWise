...
import AuraLogoMark from "../components/AuraLogoMark.jsx";
      ...
      <div className="login-card">
        <div className="login-brand">
          <span className="login-mark" aria-hidden="true">
            <AuraLogoMark size={48} />
          </span>
          <span className="login-logo">AURA<span className="login-purple">FARM</span></span>
          <span className="login-tagline">BUILD. DISCIPLINE. BECOME.</span>
        </div>

        <h1 className="login-title">CULTIVATOR ACCESS</h1>
